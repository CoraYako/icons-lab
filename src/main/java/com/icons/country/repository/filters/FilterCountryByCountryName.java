...
@Component
public class FilterCountryByCountryName implements CountryFilterStrategy {
    private final GenericPredicateBuilder genericPredicateBuilder;

    public FilterCountryByCountryName(GenericPredicateBuilder genericPredicateBuilder) {
    ...
    public Predicate apply(CountryFilterRequestDTO filters,
        ...
        return genericPredicateBuilder.build(root, criteriaBuilder, COLUMN_NAME, filters.countryName());
    }
}