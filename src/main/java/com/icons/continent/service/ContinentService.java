...
public interface ContinentService {
    ...
    Page<@NonNull ContinentResponseDTO> listContinents(int pageNumber);

    ContinentResponseDTO getContinentById(@NotNull String id);

    ContinentEntity getById(@NotNull String id);
}
